...
const NavBar = ({ mobile }) => {
	...
	const navMobileClass = classNames('header__mobile-menu', {
	...
	const servicesClass = classNames({
		active: servicesPaths.includes(location.pathname),
	})
	const chevronClass = classNames('chevron', {
		'chevron--active': servicesPaths.includes(location.pathname),
	})
	const soinsNaturelsTechniques = [
		'/ventouses',
		'/moxibustion',
		'/guasha',
		'/reflexologie-auriculaire',
	]
	const soinsNaturelsClass = classNames({
		active: soinsNaturelsTechniques.includes(location.pathname),
	})
	...
	return (
		<nav className='header__navbar'>
          ...
          */}
					...
					<span>
						<NavLink to='/consultations'>Tarifs</NavLink>
					</span>
					<span>
			...
			{mobile && (
				<>
					...
					<div className={navMobileClass}>
						...
						<span>
							<NavLink
								className={`header__sublink ${soinsNaturelsClass}`}
								to='/soins-naturels'
								onClick={closeMenu}
							>
								Soins naturels
						...
						<span>
							<NavLink to='/qui-suis-je' onClick={closeMenu}>
								Qui suis-je ?
							</NavLink>
						</span>
						<span>
